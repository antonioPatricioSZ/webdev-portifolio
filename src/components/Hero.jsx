    ...
    <div className="bg-emerald-100 py-12 md:py-24 ">
      <div className="align-element grid md:grid-cols-2 items-center gap-16">
        <article>
          ...
          <p className="mt-2 text-lg md:text-xl text-slate-700 tracking-wide">
          E estudante dedicado da área de programação. Minha paixão está em desenvolver aplicações web, tanto no Frontend quanto no Backend. Te convido á conhecer meu portfólio e explorar o mundo da programação através dos meus olhos. Vamos juntos nessa jornada de aprendizado e criação!
          </p>
